...
pub const LINK_DOCS_HOME: &str = "https://nonnix.com";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://nonnix.com";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ss.nonnix.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "MMXN1MzYAnHa3lzrDl5fNbWeoQX+BWS0UU7kFX4MLeE=";
